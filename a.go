...
func dm_build_13(dm_build_14 *DmConnection) (*dm_build_2, error) {
	...
	dm_build_17.dm_build_5 = Dm_build_1225(Dm_build_272)
...
func (dm_build_24 *dm_build_2) dm_build_23(dm_build_25 dm_build_390) bool {
	var dm_build_26 = dm_build_24.dm_build_6.dmConnector.compress
	if dm_build_25.dm_build_404() == Dm_build_299 || dm_build_26 == Dm_build_348 {
		return false
	}

	if dm_build_26 == Dm_build_346 {
		return true
	} else if dm_build_26 == Dm_build_347 {
		return !dm_build_24.dm_build_6.Local && dm_build_25.dm_build_402() > Dm_build_345
	}

	return false
}

func (dm_build_28 *dm_build_2) dm_build_27(dm_build_29 dm_build_390) bool {
	var dm_build_30 = dm_build_28.dm_build_6.dmConnector.compress
	if dm_build_29.dm_build_404() == Dm_build_299 || dm_build_30 == Dm_build_348 {
		return false
	}

	if dm_build_30 == Dm_build_346 {
		return true
	} else if dm_build_30 == Dm_build_347 {
		return dm_build_28.dm_build_5.Dm_build_1485(Dm_build_307) == 1
	}

	return false
}

func (dm_build_32 *dm_build_2) dm_build_31(dm_build_33 dm_build_390) (err error) {
	defer func() {
		if p := recover(); p != nil {
			if _, ok := p.(string); ok {
	...
	dm_build_35 := dm_build_33.dm_build_402()
	...
	if dm_build_35 > 0 {
		...
		if dm_build_32.dm_build_23(dm_build_33) {
			...
			dm_build_32.dm_build_5.Dm_build_1236(Dm_build_300)

			dm_build_32.dm_build_5.Dm_build_1273(dm_build_35)

			dm_build_32.dm_build_5.Dm_build_1301(retBytes)

			dm_build_33.dm_build_403(int32(len(retBytes)) + ULINT_SIZE)

			dm_build_32.dm_build_5.Dm_build_1405(Dm_build_307, 1)
		}

		if dm_build_32.dm_build_9 {
			dm_build_35 = dm_build_33.dm_build_402()
			var retBytes = dm_build_32.dm_build_7.Encrypt(dm_build_32.dm_build_5.Dm_build_1512(Dm_build_300, int(dm_build_35)), true)

			dm_build_32.dm_build_5.Dm_build_1236(Dm_build_300)

			dm_build_32.dm_build_5.Dm_build_1301(retBytes)

			dm_build_33.dm_build_403(int32(len(retBytes)))
		}
	}

	dm_build_33.dm_build_399()
	if dm_build_32.dm_build_263(dm_build_33) {
		if dm_build_32.dm_build_4 != nil {
			dm_build_32.dm_build_5.Dm_build_1239(0)
			dm_build_32.dm_build_5.Dm_build_1258(dm_build_32.dm_build_4)
		}
	} else {
		dm_build_32.dm_build_5.Dm_build_1239(0)
		dm_build_32.dm_build_5.Dm_build_1258(dm_build_32.dm_build_3)
	}
	return nil
}

func (dm_build_37 *dm_build_2) dm_build_36(dm_build_38 dm_build_390) (err error) {
	defer func() {
		if p := recover(); p != nil {
			if _, ok := p.(string); ok {
				err = ECGO_COMMUNITION_ERROR.addDetail("\t" + p.(string)).throw()
	...
	if dm_build_37.dm_build_263(dm_build_38) {
		if dm_build_37.dm_build_4 != nil {
			dm_build_37.dm_build_5.Dm_build_1236(0)
			dm_build_37.dm_build_5.Dm_build_1252(dm_build_37.dm_build_4, Dm_build_300)
			dm_build_40 = dm_build_38.dm_build_402()
			if dm_build_40 > 0 {
				dm_build_37.dm_build_5.Dm_build_1252(dm_build_37.dm_build_4, int(dm_build_40))
			}
		}
	} else {

		dm_build_37.dm_build_5.Dm_build_1236(0)
		dm_build_37.dm_build_5.Dm_build_1252(dm_build_37.dm_build_3, Dm_build_300)
		dm_build_40 = dm_build_38.dm_build_402()

		if dm_build_40 > 0 {
			dm_build_37.dm_build_5.Dm_build_1252(dm_build_37.dm_build_3, int(dm_build_40))
		}
	}

	dm_build_38.dm_build_400()
	...
	if dm_build_37.dm_build_9 {
		dm_build_40 = dm_build_38.dm_build_402()
		ebytes := dm_build_37.dm_build_5.Dm_build_1512(Dm_build_300, int(dm_build_40))
		bytes, err := dm_build_37.dm_build_7.Decrypt(ebytes, true)
		if err != nil {
			return err
		}
		dm_build_37.dm_build_5.Dm_build_1236(Dm_build_300)
		dm_build_37.dm_build_5.Dm_build_1301(bytes)
		dm_build_38.dm_build_403(int32(len(bytes)))
	}

	if dm_build_37.dm_build_27(dm_build_38) {

		dm_build_40 = dm_build_38.dm_build_402()
		cbytes := dm_build_37.dm_build_5.Dm_build_1512(Dm_build_300+ULINT_SIZE, int(dm_build_40-ULINT_SIZE))
...
func (dm_build_42 *dm_build_2) dm_build_41(dm_build_43 dm_build_390) (dm_build_44 interface{}, dm_build_45 error) {
	dm_build_45 = dm_build_43.dm_build_394(dm_build_43)
	if dm_build_45 != nil {
	...
	return dm_build_43.dm_build_398(dm_build_43)
}

func (dm_build_47 *dm_build_2) dm_build_46() (*dm_build_810, error) {

	Dm_build_48 := dm_build_816(dm_build_47)
...
func (dm_build_51 *dm_build_2) dm_build_50() error {
	...
	dm_build_52 := dm_build_685(dm_build_51)
...
func (dm_build_55 *dm_build_2) dm_build_54() error {
	...
	if dm_build_55.dm_build_9 || dm_build_55.dm_build_8 {
		...
		sessionKey := security.ComputeSessionKey(k, dm_build_56.Dm_build_814)
		encryptType := dm_build_56.dm_build_812
		hashType := int(dm_build_56.Dm_build_813)
		if encryptType == -1 {
...
func (dm_build_59 *dm_build_2) Dm_build_58(dm_build_60 *DmStatement) error {
	dm_build_61 := dm_build_839(dm_build_59, dm_build_60)
...
func (dm_build_64 *dm_build_2) Dm_build_63(dm_build_65 int32) error {
	dm_build_66 := dm_build_849(dm_build_64, dm_build_65)
...
func (dm_build_69 *dm_build_2) Dm_build_68(dm_build_70 *DmStatement, dm_build_71 bool, dm_build_72 int16) (*execInfo, error) {
	dm_build_73 := dm_build_722(dm_build_69, dm_build_70, dm_build_71, dm_build_72)
...
func (dm_build_77 *dm_build_2) Dm_build_76(dm_build_78 *DmStatement, dm_build_79 int16) (*execInfo, error) {
	return dm_build_77.Dm_build_68(dm_build_78, false, Dm_build_352)
}

func (dm_build_81 *dm_build_2) Dm_build_80(dm_build_82 *DmStatement, dm_build_83 []OptParameter) (*execInfo, error) {
	dm_build_84, dm_build_85 := dm_build_81.dm_build_41(dm_build_483(dm_build_81, dm_build_82, dm_build_83))
	if dm_build_85 != nil {
...
func (dm_build_91 *dm_build_2) Dm_build_90(dm_build_92 *DmStatement, dm_build_93 [][]interface{}) (*execInfo, error) {
	dm_build_94 := dm_build_506(dm_build_91, dm_build_92, dm_build_93)
...
func (dm_build_109 *dm_build_2) Dm_build_108(dm_build_110 *DmStatement, dm_build_111 []interface{}, dm_build_112 bool) (*execInfo, error) {
	...
	for icol := 0; icol < int(dm_build_110.paramCount); icol++ {
		...
		if dm_build_109.dm_build_232(dm_build_113, dm_build_111, icol) {
			...
			if !dm_build_112 {
				preExecute := dm_build_712(dm_build_109, dm_build_110, dm_build_110.params)
	...
	dm_build_115 := dm_build_506(dm_build_109, dm_build_110, dm_build_114)
...
func (dm_build_119 *dm_build_2) Dm_build_118(dm_build_120 *DmStatement, dm_build_121 int16) (*execInfo, error) {
	dm_build_122 := dm_build_699(dm_build_119, dm_build_120, dm_build_121)
...
func (dm_build_126 *dm_build_2) Dm_build_125(dm_build_127 *innerRows, dm_build_128 int64) (*execInfo, error) {
	dm_build_129 := dm_build_606(dm_build_126, dm_build_127, dm_build_128, INT64_MAX)
...
func (dm_build_133 *dm_build_2) Commit() error {
	dm_build_134 := dm_build_469(dm_build_133)
...
func (dm_build_137 *dm_build_2) Rollback() error {
	dm_build_138 := dm_build_760(dm_build_137)
...
func (dm_build_141 *dm_build_2) Dm_build_140(dm_build_142 *DmConnection) error {
	dm_build_143 := dm_build_765(dm_build_141, dm_build_142.IsoLevel)
...
func (dm_build_146 *dm_build_2) Dm_build_145(dm_build_147 *DmStatement, dm_build_148 string) error {
	dm_build_149 := dm_build_474(dm_build_146, dm_build_147, dm_build_148)
...
func (dm_build_152 *dm_build_2) Dm_build_151(dm_build_153 []uint32) ([]int64, error) {
	dm_build_154 := dm_build_857(dm_build_152, dm_build_153)
...
func (dm_build_161 *dm_build_2) dm_build_160(dm_build_162 *lob) (int64, error) {
	dm_build_163 := dm_build_637(dm_build_161, dm_build_162)
...
func (dm_build_167 *dm_build_2) dm_build_166(dm_build_168 *lob, dm_build_169 int32, dm_build_170 int32) ([]byte, error) {
	dm_build_171 := dm_build_624(dm_build_167, dm_build_168, int(dm_build_169), int(dm_build_170))
...
func (dm_build_175 *dm_build_2) dm_build_174(dm_build_176 *DmBlob, dm_build_177 int32, dm_build_178 int32) ([]byte, error) {
	...
	for dm_build_180 < dm_build_178 {
		...
		if dm_build_181 > Dm_build_385 {
			dm_build_181 = Dm_build_385
		}
		...
		Dm_build_868.Dm_build_924(dm_build_179, int(dm_build_180), dm_build_182, 0, len(dm_build_182))
...
func (dm_build_185 *dm_build_2) dm_build_184(dm_build_186 *DmClob, dm_build_187 int32, dm_build_188 int32) (string, error) {
	...
	for dm_build_190 < dm_build_188 {
		...
		if dm_build_191 > Dm_build_385/2 {
			dm_build_191 = Dm_build_385 / 2
		}
		...
		dm_build_193 = Dm_build_868.Dm_build_1022(dm_build_192, 0, len(dm_build_192), dm_build_186.serverEncoding, dm_build_185.dm_build_6)
...
func (dm_build_196 *dm_build_2) dm_build_195(dm_build_197 *DmClob, dm_build_198 int, dm_build_199 string, dm_build_200 string) (int, error) {
	var dm_build_201 = Dm_build_868.Dm_build_1078(dm_build_199, dm_build_200, dm_build_196.dm_build_6)
	var dm_build_202 = 0
	var dm_build_203 = len(dm_build_201)
	var dm_build_204 = 0
	var dm_build_205 = 0
	var dm_build_206 = 0
	var dm_build_207 = dm_build_203/Dm_build_384 + 1
	...
	for i := 0; i < dm_build_207; i++ {
		...
		if dm_build_206 > Dm_build_384 {
			dm_build_206 = Dm_build_384
		}

		setLobData := dm_build_779(dm_build_196, &dm_build_197.lob, dm_build_208, dm_build_198, dm_build_201, dm_build_202, dm_build_206)
...
func (dm_build_212 *dm_build_2) dm_build_211(dm_build_213 *DmBlob, dm_build_214 int, dm_build_215 []byte) (int, error) {
	...
	var dm_build_219 = 0
	var dm_build_220 = 0
	var dm_build_221 = dm_build_217/Dm_build_384 + 1
	...
	for i := 0; i < dm_build_221; i++ {
		...
		if dm_build_220 > Dm_build_384 {
			dm_build_220 = Dm_build_384
		}

		setLobData := dm_build_779(dm_build_212, &dm_build_213.lob, dm_build_222, dm_build_214, dm_build_215, dm_build_216, dm_build_220)
...
func (dm_build_226 *dm_build_2) dm_build_225(dm_build_227 *lob, dm_build_228 int) (int64, error) {
	dm_build_229 := dm_build_648(dm_build_226, dm_build_227, dm_build_228)
...
func (dm_build_239 *dm_build_2) dm_build_238(dm_build_240 *DmStatement, dm_build_241 parameter, dm_build_242 int, dm_build_243 iOffRowBinder) error {
	var dm_build_244 = Dm_build_1148()
	dm_build_243.read(dm_build_244)
	var dm_build_245 = 0
	for !dm_build_243.isReadOver() || dm_build_244.Dm_build_1149() > 0 {
		if !dm_build_243.isReadOver() && dm_build_244.Dm_build_1149() < Dm_build_384 {
			dm_build_243.read(dm_build_244)
		}
		if dm_build_244.Dm_build_1149() > Dm_build_384 {
			dm_build_245 = Dm_build_384
		} else {
			dm_build_245 = dm_build_244.Dm_build_1149()
		}

		putData := dm_build_750(dm_build_239, dm_build_240, int16(dm_build_242), dm_build_244, int32(dm_build_245))
...
func (dm_build_264 *dm_build_2) dm_build_263(dm_build_265 dm_build_390) bool {
	return dm_build_265.dm_build_404() != Dm_build_299 && dm_build_264.dm_build_6.sslEncrypt == 1
}
